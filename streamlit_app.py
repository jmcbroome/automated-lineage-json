...
with st.form(key="autolin"):
    ...
    floor = st.number_input("Minimum genotype representation score to annotate a lineage. This is an abstract value that considers both the number and distinction of descendent samples. Set to a higher value to prevent the designation of marginal lineage labels representing few or similar samples.",min_value=0)
